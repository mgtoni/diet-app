    ...
    <div className="min-h-screen bg-gray-950 text-white p-6 pb-24 font-sans selection:bg-emerald-500/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <ScoreCard 
          ...
          barGradientClass="bg-gradient-to-r from-orange-400 to-teal-400"
          bubbleClass="bg-teal-500/10 group-hover:bg-teal-500/20"
          hoverBorderClass="hover:border-teal-500/50"
          explanation={
            <>
              <p>
                Your <strong>Diet Quality Score</strong> evaluates the overall healthfulness and diversity of your diet, beyond just calories and macros.
              </p>
              <p className="mt-2">
                It factors in:
              </p>
              ...
              <p className="mt-2">
                Focus on eating a variety of minimally processed, nutrient-dense foods to improve this score.
              </p>
            </>
          }
        />
...
function ScoreCard({ 
  ...
  return (
    <>
      <div className={`bg-gray-900/80 backdrop-blur-md rounded-3xl p-6 md:pb-6 pb-12 border border-gray-800 shadow-xl relative overflow-hidden group ${hoverBorderClass} transition-all duration-500 flex flex-col`}>
